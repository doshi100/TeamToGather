<%@ Page Title="" Language="C#" MasterPageFile="~/TeamTogatherMaster.Master" AutoEventWireup="true" CodeBehind="UpdateProject.aspx.cs" Inherits="TeamTogatherWebUI.UpdateProject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="editor_section_contain">
        ...
        <div class="White_Section_editor">
            <div class="Section_editor">
                ...
                <div class="editor">
                    <div id="editor_header" runat="server" class="editor_header" contenteditable="true" placeholder="Project's Name" >
                    </div>
                    ...
                    <div class="SubHeader_container">
                        ...
                        <div class="editor_Summary" id="editor_Summary" runat="server" contenteditable="true"></div>
                    ...
                    <div class="editor_Content">
                        <div class="editor_Text" id="editor_Text" runat="server" contenteditable="true">
                        </div>
                    </div>
                    <%--</div>--%>
                </div>
    ...
    <asp:HiddenField ID="UserAdmin" Value="" runat="server" />
    ...
    <div class="ProjCreSection2">
        ...
        <div class="GraySection">
            <span class="Header">Add Positions To the Project</span>
